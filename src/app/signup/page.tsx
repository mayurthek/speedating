...
export default function SignUpPage() {
  ...
  const handleSignUp = async (provider: 'google' | 'apple' | 'email', customEmail?: string) => {
    setLoading(true);
    setError(null);
    ...
    try {
      const res = await fetch('/api/auth/login', {
        ...
        body: JSON.stringify({ email: authEmail, provider, isSignUp: true }),
      });
      ...
      // New users must always be routed to profile setup
      ...
      <main style={{ maxWidth: '440px', margin: '40px auto 0', width: '100%' }}>
        <div className="panel">
          <div style={{ textAlign: 'center', marginBottom: '24px' }}>
            ...
            <p className="type-meta">Speedating is strictly 18+. Get started in seconds.</p>
          </div>
          ...
          >
            <div>
              <label htmlFor="signup-email" className="type-controls" style={{ display: 'block', marginBottom: '6px' }}>
